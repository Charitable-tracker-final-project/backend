...
urlpatterns = [
    ...
    path("api/upload/<int:pk>/", cviews.DocumentDetailView.as_view()),
    ...
    path('api/Dsort/', cviews.DonationAllRecordListView.as_view()),
    path('api/Vsort/', cviews.VolunteerAllRecordListView.as_view()),
